...
namespace Munch
{
    ...
    public class AP_VR_IngredientActivity : Activity
    {
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            parsedData.Insert(0, (new AP_VR_IngredientList() { ingredientName = "Name", unitMeasure = "Measurement Unit", amtUsed = "Amount Used", date = "Time" }));
            ...
            btns[0].Click += async (sender, e) =>
            {
                ...
                mListView = FindViewById<ListView>(Resource.Id.IngredientReportListView);
                dailyparsedData.Insert(0, (new AP_VR_IngredientList() { ingredientName = "Name", unitMeasure = "Measurement Unit", amtUsed = "Amount Used", date = "Time" }));
            ...
            btns[1].Click += async (sender, e) =>
            {
                ...
                mListView = FindViewById<ListView>(Resource.Id.IngredientReportListView);
                weeklyparsedData.Insert(0, (new AP_VR_IngredientList() { ingredientName = "Name", unitMeasure = "Measurement Unit", amtUsed = "Amount Used", date = "Time" }));
            ...
            btns[2].Click += async (sender, e) =>
            {
                ...
                mListView = FindViewById<ListView>(Resource.Id.IngredientReportListView);
                monthlyparsedData.Insert(0, (new AP_VR_IngredientList() { ingredientName = "Name", unitMeasure = "Measurement Unit", amtUsed = "Amount Used", date = "Time" }));
            ...
            btns[3].Click += async (sender, e) =>
            {
                ...
                mListView = FindViewById<ListView>(Resource.Id.IngredientReportListView);
                yearlyparsedData.Insert(0, (new AP_VR_IngredientList() { ingredientName = "Name", unitMeasure = "Measurement Unit", amtUsed = "Amount Used", date = "Time" }));
