...
namespace Munch
{
    public class CV_SlidingTabScrollView : HorizontalScrollView
    {
        ...
        private static CV_SlidingTabStrip mTabStrip;
        ...
        public CV_SlidingTabScrollView(Context context) : this(context, null) { }

        public CV_SlidingTabScrollView(Context context, IAttributeSet attrs) : this(context, attrs, 0) { }

        public CV_SlidingTabScrollView(Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
        {
            ...
            mTabStrip = new CV_SlidingTabStrip(context);
