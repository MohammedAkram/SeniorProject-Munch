...
namespace Munch
{
    class CV_SlidingTabStrip : LinearLayout
    {
        ...
        //Tab colorizer
        private CV_SlidingTabScrollView.TabColorizer mCustomTabColorizer;
        private SimpleTabColorizer mDefaultTabColorizer;
        //Stop copy and paste here........................................................................

        //Constructors
        public CV_SlidingTabStrip(Context context) : this(context, null)
        { }

        public CV_SlidingTabStrip(Context context, IAttributeSet attrs) : base(context, attrs)
        {
        ...
        public CV_SlidingTabScrollView.TabColorizer CustomTabColorizer
        {
            set
            {
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            CV_SlidingTabScrollView.TabColorizer tabColorizer = mCustomTabColorizer != null ? mCustomTabColorizer : mDefaultTabColorizer;
        ...
        private class SimpleTabColorizer : CV_SlidingTabScrollView.TabColorizer
        {
